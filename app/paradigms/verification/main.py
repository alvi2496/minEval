...
def verify(data):
	...
	print("***************************************************")
	print("Naive Bayes")
	count_result_array, count_result, tf_idf_result_array, tf_idf_result = naive_bayes.cross_verification(data, 10)
	...
	print("###################################################")
	print("Random Forest")
	count_result_array, count_result, tf_idf_result_array, tf_idf_result = random_forest.cross_verification(data, 10)
	print("Using Count Vector")
	print("Result of cross validation:", count_result_array)
	print("Average of cross validation:", count_result)
	print("Using TF-IDF Vector")
	...
	print("###################################################")
	print("Support Vector Machine")
	count_result_array, count_result, tf_idf_result_array, tf_idf_result = svm.cross_verification(data, 10)
	print("Using Count Vector")
	print("Result of cross validation:", count_result_array)
	print("Average of cross validation:", count_result)
	print("Using TF-IDF Vector")
