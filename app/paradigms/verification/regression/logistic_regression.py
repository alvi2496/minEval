...
def split_validation(data, test_size_for_split):
	...
	trained_classifier_with_count = trainer.train(linear_model.LogisticRegression(), train_data_count, train_label)
	trained_classifier_with_tf_idf = trainer.train(linear_model.LogisticRegression(), train_data_tf_idf, train_label)
...
def cross_verification(data, feature_vectors, n):
	...
	word_embedd_result_array, word_embedd_result = verifier.cross_verifier(linear_model.LogisticRegression(), \
